...
package ru.bootcode.crdiet.database.eattime;
...
public class EatTime {
    ...
    public EatTime(@NonNull String id, int number, Date date, int weektype_id, String comment, boolean delete, int weigth) {
        this.id = id;
        this.number = number;
        this.date = date;
    ...
    @Ignore
    public EatTime(int number, Date date, int weektype_id, String comment, boolean delete, int weigth) {
