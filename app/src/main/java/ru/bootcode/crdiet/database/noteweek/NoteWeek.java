...
public class NoteWeek {
    ...
    public NoteWeek(@NonNull String id, int number, Date date, int weektype_id, String comment, boolean delete, int weigth) {
        this.id = id;
        this.number = number;
        this.date = date;
    ...
    @Ignore
    public NoteWeek( int number, Date date, int weektype_id, String comment, boolean delete, int weigth) {
