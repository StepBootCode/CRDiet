...
public class EatTimeAdapter extends RecyclerView.Adapter<EatTimeAdapter.ViewHolder>{

    // Стандартный адаптер, все особенности откоментрованы в коде функций

    private List<EatTime> notesLists;
    public EatTimeAdapter(List<EatTime> myDataLists) {
...
/*
    ...
    public EatTime getItemNote(int i) {
