...
public class NoteDayAdapter extends RecyclerView.Adapter<NoteDayAdapter.ViewHolder>{

    // Стандартный адаптер, все особенности откоментрованы в коде функций

    private List<NoteDay> notesLists;
    public NoteDayAdapter(List<NoteDay> myDataLists) {
...
/*
    ...
    public NoteDay getItemNote(int i) {
