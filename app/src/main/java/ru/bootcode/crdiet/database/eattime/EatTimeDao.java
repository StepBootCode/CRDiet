...
public interface EatTimeDao {
    ...
    Flowable<EatTime> getById(String id);

    @Insert
    void insert(EatTime noteWeek);

    @Update
    void update(EatTime noteWeek);

    @Delete
    void delete(EatTime noteWeek);
}
